...
public class Esame {
	...
	private String docente;		//oppure se è un app più articolata ho una classe di Docente 
	 ...
	 * Se invere già era superato genera un 'eccezione 
	 * non possono essere chiamati dall'eserno i metodi setvoto e setdatasuperamento in modo da tutelare il senso del codice
	 * @param voto
	 * @param data
	 */
